...
## 2.5 Operators for filtering data %>% = and then something
...
2.8 continued...
#calling column names that would otherwise error
```{r}
...
gapdata %>% 
  ...
  geom_line() + facet_wrap(~continent) + theme_bw() + scale_colour_brewer(palette = "Paired")
```
...
gapdata2007 %>% 
  ...
  geom_col(fill = NA, colour = "deepskyblue") + coord_flip() + theme_classic()
```
